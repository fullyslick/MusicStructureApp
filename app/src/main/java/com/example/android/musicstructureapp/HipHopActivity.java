...
public class HipHopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button wildButton = (Button) findViewById(R.id.wild);
        Button hotButton = (Button) findViewById(R.id.hot);
        Button powerButton = (Button) findViewById(R.id.power);
        Button jamnButton = (Button) findViewById(R.id.jamn);
        ...
        wildButton.setTypeface(typefaceCustomFont);
        hotButton.setTypeface(typefaceCustomFont);
        powerButton.setTypeface(typefaceCustomFont);
        jamnButton.setTypeface(typefaceCustomFont);
        ...
        retrunButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent genreIntent = new Intent(HipHopActivity.this, MainActivity.class);
                startActivity(genreIntent);
            }
        });

        //Changes the string of Status textView, set radioSelected & RadioPlaying variables to true
        // and allow play button to switch to pause, should play audio - Radio Changer Functionality for Hot 97 radio
        hotButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.hot);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for Power 106 radio
        powerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.power);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for Wild 94.9 radio
        wildButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.wild);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for Jam'n radio
        jamnButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.jamn);
                setRadioPlaying();
            }
        });
    }
