...
public class DiscoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button discopalaceButton = (Button) findViewById(R.id.discopalace);
        Button seventiesdisconightsButton = (Button) findViewById(R.id.seventiesdisconights);
        Button funkstationButton = (Button) findViewById(R.id.funkstation);
        Button euroButton = (Button) findViewById(R.id.euro);
        Button maxitaloButton = (Button) findViewById(R.id.maxitalo);
        ...
        discopalaceButton.setTypeface(typefaceCustomFont);
        maxitaloButton.setTypeface(typefaceCustomFont);
        seventiesdisconightsButton.setTypeface(typefaceCustomFont);
        euroButton.setTypeface(typefaceCustomFont);
        funkstationButton.setTypeface(typefaceCustomFont);
        ...
        retrunButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent genreIntent = new Intent(DiscoActivity.this, MainActivity.class);
                startActivity(genreIntent);
            }
        });

        //Changes the string of Status textView, set radioSelected & RadioPlaying variables to true
        // and allow play button to switch to pause, should play audio - Radio Changer Functionality for Disco Palace radio
        discopalaceButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.discopalace);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for 70s Disco Nights radio
        seventiesdisconightsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.seventiesdisco);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for Max Italo radio
        maxitaloButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.maxitalo);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for Funk Station radio
        funkstationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.funkstation);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for Euro 80s radio
        euroButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.euroeighties);
                setRadioPlaying();
            }
        });
    }
