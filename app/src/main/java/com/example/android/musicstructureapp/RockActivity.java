...
public class RockActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button swhrockButton = (Button) findViewById(R.id.swhrock);
        Button wzxrButton = (Button) findViewById(R.id.wzxr);
        Button klaqButton = (Button) findViewById(R.id.klaq);
        Button planetrockButton = (Button) findViewById(R.id.planetrock);
        ...
        swhrockButton.setTypeface(typefaceCustomFont);
        wzxrButton.setTypeface(typefaceCustomFont);
        klaqButton.setTypeface(typefaceCustomFont);
        planetrockButton.setTypeface(typefaceCustomFont);
        ...
        retrunButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent genreIntent = new Intent(RockActivity.this, MainActivity.class);
                startActivity(genreIntent);
            }
        });

        //Changes the string of Status textView, set radioSelected & RadioPlaying variables to true
        // and allow play button to switch to pause, should play audio - Radio Changer Functionality for WZXR radio
        wzxrButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.wzxr);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for Klaq radio
        klaqButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.klaq);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for SWH Rock radio
        swhrockButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                radioListening = getString(R.string.swhrock);
                setRadioPlaying();
            }
        });
        //Radio Changer Functionality for Planet Rock radio
        planetrockButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
